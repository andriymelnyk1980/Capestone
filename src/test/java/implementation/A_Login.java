...
@Test
public class A_Login extends DriverSetup{
	
	public static void A_LoginMethod() throws InterruptedException, IOException {
		...
		Thread.sleep(1000);
		CommonObject.get_Email().sendKeys(prop.getProperty("EmailInput"));
		Thread.sleep(1000);
		CommonObject.get_password().clear();
		Thread.sleep(1000);
		CommonObject.get_password().sendKeys(prop.getProperty("Password"));
		Thread.sleep(1000);
